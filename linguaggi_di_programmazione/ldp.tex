...
induttiva, quindi \\$(B_{tree},root,branch)$ è un'algebra induttiva.
    ...
    \begin{proof}[\textbf{Soluzione}] Per prima cosa verifichiamo che $(P,\varnothing_P,\sigma_P)$ sia un'algebra induttiva:
        \begin{itemize}
            \item [(i)] $\sigma_P$ e $\varnothing_P:\mathds{1}\to P$, sono chiaramente inisettive, infatti se $\sigma_P(n) =\sigma_P(m)$ e quindi
                  $n+2 = m+2\implies n=m$.
            \item [(ii)] Im $\sigma_P \cap $ Im $\varnothing_P = \varnothing$
            \item [(iii)] Chiaramente se $S\subseteq P$ è chiuso rispetto a $\varnothing_P$ e $\sigma_P$, allora  $S$ deve essere necessariamente $P$.
        \end{itemize}
